...
[CreateAssetMenu(menuName = "Events/DisputeEvent")]
public class DisputeEvent : Event {

	public override void Instantiate()
	{
		GameManager.Instance.interfaceHandler.questionText.text = "Soll jemand dort hingeschickt werden?";
